...
*/
	...
	*/
	...
	fprintf(cgiOut, "<font size=\"8\" color = \"#ff00000000\">PARAMETERS LIST:  </font>\n");
	fprintf(cgiOut, "<p align=\"center\">&nbsp;</p>");

	fprintf(cgiOut, "<font size=\"4\">Temperature upper limits:  %d</font>\n", msg.tmp_max);
	fprintf(cgiOut, "<p align=\"center\">&nbsp;</p>");
	fprintf(cgiOut, "<font size=\"4\">Temperature lower limits:  %d</font>\n\n\n", msg.tmp_min);
	fprintf(cgiOut, "<p align=\"center\">&nbsp;</p>");

	fprintf(cgiOut, "<font size=\"4\">Humidity upper limits:  %d</font>\n", msg.water_max);
	fprintf(cgiOut, "<p align=\"center\">&nbsp;</p>");
	fprintf(cgiOut, "<font size=\"4\">Humidity lower limits:  %d</font>\n", msg.water_min);
	fprintf(cgiOut, "<p align=\"center\">&nbsp;</p>");

	fprintf(cgiOut, "<font size=\"4\">Fog upper limits:  %d</font>\n", msg.mq_max);

	fprintf(cgiOut, "<p align=\"center\">&nbsp;</p>");
	fprintf(cgiOut, "<font size=\"8\" color = \"blue\">Send data to main process......</font>\n");

	fprintf(cgiOut, "<meta http-equiv=\"refresh\" content=\"2;url=../main.html\"/>\n");
//	sqlite3_close(db);
	//	}
	fprintf(cgiOut,"</body>\n");
	fprintf(cgiOut,"</html>\n");
